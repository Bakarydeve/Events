...
<!-- BERTE BAKARY -->
<!-- 14/11/2019 -->
<!-- Ce site est pour les étudiants -->
                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="affichagecategorie.php">Categorie</a>
                                    <li><a href="session.php">Connexion</a>
                                </ul>
                            </div>
                            <!-- end nav-collapse -->
                        </nav>
     ...
     if ($result1 == false) //Erreur lors de l’exécution de la requête
        ...
        */
        ...
        /*  
     	...
     	$requete="SELECT * FROM t_news_new where new_etat = 'L';";
     	...
     	else //La requête s’est bien exécutée (<=> couleur verte dans phpmyadmin)
     	{
     		...
     		{
     			echo ($actu['new_titre']  . ' ' . $actu['new_texte'] . ' ' . $actu['new_date'] . ' ' . $actu['cpt_pseudo']);
     			echo "<br />";
     		}
        ...
        // Version 1.1
        /*
        //Préparation de la requête récupérant les identifiants de toutes les catégories présentes dans la base de données        
        $requete4="SELECT cat_id FROM t_categorie_cat;";
        ...
        if ($result4 == false) //Erreur lors de l’exécution de la requête
           {   // La requête a echoué
        ...
        else //La requête s’est bien exécutée (<=> couleur verte dans phpmyadmin)
            {
               ...
               echo("Nombre de categorie: $result4->num_rows"); //Donne le bon nombre de lignes récupérées

               echo "<br />";

            while ($idcat = $result4->fetch_assoc())
               {
                  echo ($idcat['cat_id']);
                  echo "<br />";
               }
        ...
        */
        ...
        //Préparation de la requête récupérant  toutes les informations d’une catégorie dont on connaît l’identifiant.
        /*
        $ind = '1';
        $requete5="SELECT * FROM t_information_inf where cat_id = $ind;";
        ...
        if ($result5 == false) //Erreur lors de l’exécution de la requête
           {   // La requête a echoué
        ...
        else //La requête s’est bien exécutée (<=> couleur verte dans phpmyadmin)
            {
               ...
               echo($result5->num_rows); //Donne le bon nombre de lignes récupérées

               echo "<br />";

               while ($info = $result5->fetch_assoc())
                	{
                		echo ($info['inf_texte']  . ' ' . $info['inf_date']);
                		echo "<br />";
            		}
