...
<form action="redacteur_url_action.php" method="post">
<fieldset>
...
<form action="redacteur_urlsup_action.php" method="post">
<fieldset>
 <legend>Veuillez remplir le champs si dessous pour pouvoir supprimer un lien :</legend>
