	...
	else                 //Requête réussie
	{
		if($resultat->num_rows == 1)	{
			...
			if($categorie['autorisation'] == "R")	{
				...
				{
					echo("Information supprimé avec succès de la catégorie $idcat");
					exit;
				}
			}
			else if($categorie['autorisation'] == "G")
			{
				echo("Vous n'etez pas autorisé à supprimé des informations dans cette catégorie");
				exit;
			}
	}
}
