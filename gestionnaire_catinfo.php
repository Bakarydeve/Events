        ...
        else //La requête s’est bien exécutée (<=> couleur verte dans phpmyadmin)
        {
            ...
            else
            {
            	...
            	while ($info = $result2->fetch_assoc())	{
                	echo ($info['inf_id']  . ' ' .  $info['inf_texte']  . ' ' . $info['inf_date']  . ' ' . $info['inf_etat']);
                	echo "<br />";
            	}
...
<form action="gestionnaire_catinfo_action.php" method="post">
<fieldset>
...
<form action="gestionnaire_catinfo_modif_action.php" method="post">
<fieldset>
 <legend>Veuillez saisir l'identifiant et l'etat de l'information à activé ou désactive :</legend>
...
<form action="gestionnaire_catsupinfo_action.php" method="post">
<fieldset>
 <legend>Veuillez saisir l'identifiant de l'information à supprime :</legend>
 <p>Identifiant :
 <input type="text" name="numero" placeholder="inf_id" required="required" />
 </p>
 <p><input type="submit" value="Valider"></p>
