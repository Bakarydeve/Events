...
$mysqli->close();
?>
// Formulaire html agissant sur le fichier gestionnaire_actualite_action.php" une fois le boutton valide appuyé.
<form action="gestionnaire_actualite_action.php" method="post">
<fieldset>
...
<form action="gestionnaire_supactu_action.php" method="post">
<fieldset>
 <legend>Veuillez saisir le numero de l'actualité à supprimé :</legend>
 <p>Numéro de l'actualité :
 <input type="text" name="numero" placeholder="new_id" required="required" />
 </p>
 <p><input type="submit" value="Valider"></p>
...
<form action="gestionnaire_ajoactu_action.php" method="post">
<fieldset>
 <legend>Veuillez remplir les champs si dessous :</legend>
 <p>Titre de l'actualité :
 <input type="text" name="nom" placeholder="new_titre" required="required" />
 </p>
  <p>Chaine à inseré :
